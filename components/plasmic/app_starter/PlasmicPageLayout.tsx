...
// Plasmic Project: m5GDWBq3GgoTsw95cuuuwQ
// Component: 98qnVOR1_Tdv
...
import projectcss from "./plasmic_app_starter.module.css"; // plasmic-import: m5GDWBq3GgoTsw95cuuuwQ/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: 98qnVOR1_Tdv/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: PuKNSPmqy7rU/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: G5PxJqoc3M05/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__r0GnM)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___0VtqU)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__kaHvf)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox___4NgDt)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___7Hpwq)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,

...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: 7w1WX11bdzxL/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 2qpWbu1iU48l/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: GYDLrBav0khM/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__gN421)}
          role={"img"}
        />
      }
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__qDg5)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__ltvK)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__gcyG7)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__rMn9U)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
